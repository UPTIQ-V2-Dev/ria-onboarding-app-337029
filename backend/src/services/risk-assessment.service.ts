...
import { RiskAssessment } from '../generated/prisma/index.js';
 ...
 */
const getRiskAssessmentByClientId = async (clientId: string): Promise<RiskAssessment | null> => {
 ...
 * @returns {Promise<RiskAssessment>}
 */
const updateRiskAssessmentByClientId = async (
    clientId: string,
    updateData: {
        investmentExperience?: string;
        riskTolerance?: string;
 ...
 * @returns {Promise<RiskAssessment>}
 */
const deleteRiskAssessmentByClientId = async (clientId: string): Promise<RiskAssessment> => {
    const existingAssessment = await getRiskAssessmentByClientId(clientId);
    if (!existingAssessment) {
        throw new ApiError(httpStatus.NOT_FOUND, 'Risk assessment not found');
    }
