...
import { ComplianceAgreement, Disclosure } from '../generated/prisma/index.js';
 ...
 */
const getDisclosures = async (): Promise<Disclosure[]> => {
 ...
 */
const getDisclosureById = async (disclosureId: string): Promise<Disclosure | null> => {
 ...
 */
const createComplianceAgreements = async (
    clientId: string,
 ...
 * @returns {Promise<ComplianceAgreement[]>}
 */
const getClientComplianceAgreements = async (clientId: string): Promise<ComplianceAgreement[]> => {
 ...
 */
const checkClientCompliance = async (
    clientId: string
): Promise<{ compliant: boolean; missingDisclosures: string[] }> => {
