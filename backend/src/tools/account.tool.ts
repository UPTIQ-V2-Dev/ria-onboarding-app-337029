...
const getAccountTypesTool: MCPTool = {
...
const createAccountsTool: MCPTool = {
...
const getAccountTypeByIdTool: MCPTool = {
    ...
    fn: async (inputs: { accountTypeId: string }) => {
...
export const accountTools: MCPTool[] = [getAccountTypesTool, createAccountsTool, getAccountTypeByIdTool];
