import { investmentObjectivesService } from '../services/index.ts';
...
const createInvestmentObjectivesTool: MCPTool = {
...
const getInvestmentObjectivesByIdTool: MCPTool = {
...
const getInvestmentObjectivesByClientIdTool: MCPTool = {
...
const updateInvestmentObjectivesByIdTool: MCPTool = {
...
const updateInvestmentObjectivesByClientIdTool: MCPTool = {
...
const deleteInvestmentObjectivesByIdTool: MCPTool = {
...
const deleteInvestmentObjectivesByClientIdTool: MCPTool = {
...
export const investmentObjectivesTools: MCPTool[] = [
