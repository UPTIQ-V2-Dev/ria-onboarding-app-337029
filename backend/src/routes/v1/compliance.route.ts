import { complianceController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { complianceValidation } from '../../validations/index.ts';
...
router
    ...
    .post(
        auth(),
        validate(complianceValidation.createComplianceAgreements),
        complianceController.createComplianceAgreements
    );
...
router
    ...
    .get(
        auth(),
        validate(complianceValidation.getClientCompliance),
        complianceController.getClientComplianceAgreements
    );
