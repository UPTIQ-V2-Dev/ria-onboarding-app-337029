import { investmentObjectivesController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { investmentObjectivesValidation } from '../../validations/index.ts';
...
router.post(
    '/',
    auth('manageClients'),
    validate(investmentObjectivesValidation.createInvestmentObjectives),
    investmentObjectivesController.createInvestmentObjectives
);
...
router.get(
    '/:id',
    auth('getClients'),
    validate(investmentObjectivesValidation.getInvestmentObjectivesById),
    investmentObjectivesController.getInvestmentObjectivesById
);
...
router.patch(
    '/:id',
    auth('manageClients'),
    validate(investmentObjectivesValidation.updateInvestmentObjectivesById),
    investmentObjectivesController.updateInvestmentObjectivesById
);
...
router.delete(
    '/:id',
    auth('manageClients'),
    validate(investmentObjectivesValidation.deleteInvestmentObjectivesById),
    investmentObjectivesController.deleteInvestmentObjectivesById
);
...
router.get(
    '/client/:clientId',
    auth('getClients'),
    validate(investmentObjectivesValidation.getInvestmentObjectivesByClientId),
    investmentObjectivesController.getInvestmentObjectivesByClientId
);
...
router.patch(
    '/client/:clientId',
    auth('manageClients'),
    validate(investmentObjectivesValidation.updateInvestmentObjectivesByClientId),
    investmentObjectivesController.updateInvestmentObjectivesByClientId
);
...
router.delete(
    '/client/:clientId',
    auth('manageClients'),
    validate(investmentObjectivesValidation.deleteInvestmentObjectivesByClientId),
    investmentObjectivesController.deleteInvestmentObjectivesByClientId
);
