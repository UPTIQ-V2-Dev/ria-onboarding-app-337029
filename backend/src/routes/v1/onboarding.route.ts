import { onboardingController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { onboardingValidation } from '../../validations/index.ts';
...
router
    .route('/')
    .post(
        auth('manageOnboarding'),
        validate(onboardingValidation.createOnboarding),
...
router
    ...
    .post(
        auth('manageOnboarding'),
        validate(onboardingValidation.submitOnboarding),
...
router
    ...
    .put(
        auth('manageOnboarding'),
        validate(onboardingValidation.updateOnboardingStep),
...
router
    ...
    .get(
        auth('getOnboarding'),
        validate(onboardingValidation.getOnboardingSummary),
        onboardingController.getOnboardingSummary
    );
