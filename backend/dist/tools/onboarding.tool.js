...
const updateOnboardingStepTool = {
    ...
    outputSchema: onboardingDataSchema,
    fn: async (inputs) => {
        const result = await onboardingService.updateOnboardingStep(inputs.clientId, inputs.stepNumber, inputs.stepData);
        return {
            clientId: result.clientId,
            personalInfo: result.personalInfo,
            contactInfo: result.contactInfo,
...
const getOnboardingSummaryTool = {
