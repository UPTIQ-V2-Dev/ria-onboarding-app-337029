import { complianceService } from "../services/index.js";
import { z } from 'zod';
...
const createComplianceAgreementsTool = {
...
const checkClientComplianceTool = {
...
const getClientComplianceAgreementsTool = {
        ...
        return {
            agreements: agreements.map(agreement => ({
                ...
                disclosure: {
                    ...
                    createdAt: agreement.disclosure.createdAt.toISOString(),
                    updatedAt: agreement.disclosure.updatedAt.toISOString()
                }
            }))
        };
    }
