...
import riskAssessmentValidation from "../../validations/risk-assessment.validation.js";
 ...
 */
router.post('/', auth('manageRiskAssessments'), validate(riskAssessmentValidation.createRiskAssessment), riskAssessmentController.createRiskAssessment);
/**
 * @swagger
...
router
    .route('/:clientId')
    .get(auth('getRiskAssessments'), validate(riskAssessmentValidation.getRiskAssessment), riskAssessmentController.getRiskAssessment)
    .patch(auth('manageRiskAssessments'), validate(riskAssessmentValidation.updateRiskAssessment), riskAssessmentController.updateRiskAssessment)
    .delete(auth('manageRiskAssessments'), validate(riskAssessmentValidation.deleteRiskAssessment), riskAssessmentController.deleteRiskAssessment);
