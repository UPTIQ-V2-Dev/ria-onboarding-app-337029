...
async function main() {
    ...
    const disclosures = [
        ...
        },
        {
            ...
            content: 'This privacy policy describes how we collect and use your personal information. We collect personal information that you provide to us when you register for an account, use our services, or contact us. We use this information to provide, maintain, and improve our services, process transactions, and communicate with you.',
            required: true
        },
        {
            id: 'terms_of_service',
            title: 'Terms of Service',
            content: 'These terms of service govern your use of our platform and services. By using our services, you agree to these terms. Our services are provided "as is" without warranties of any kind. We reserve the right to modify these terms at any time with notice to users.',
            required: true
        },
        {
            id: 'fee_disclosure',
            title: 'Fee Disclosure Statement',
            content: 'This document outlines all fees associated with your account and investment services. Management fees, transaction fees, and other charges may apply. Please review this document carefully and contact us if you have any questions about the fees associated with your account.',
            required: true
        },
        {
        ...
        },
        {
            ...
            content: 'Our firm is registered with the Securities and Exchange Commission (SEC) and is subject to regulatory oversight. We are required to act in your best interest when providing investment advice. This disclosure provides information about our regulatory status, business practices, and potential conflicts of interest.',
            required: true
        },
        {
            id: 'electronic_communications',
            title: 'Electronic Communications Agreement',
            content: 'By agreeing to this electronic communications consent, you agree to receive account statements, confirmations, legal notices, and other communications electronically rather than in paper format. You can withdraw your consent at any time by contacting us.',
            required: false
        },
        {
            id: 'data_sharing',
            title: 'Data Sharing and Third-Party Services',
            content: 'We may share your information with third-party service providers to help us operate our business and serve you better. These providers are bound by confidentiality agreements and are prohibited from using your information for any other purpose.',
            required: false
        }
    ];
    ...
    for (const agreementData of complianceAgreements) {
        ...
        console.log('✅ Created compliance agreement for client:', agreement.clientId, 'disclosure:', agreement.disclosureId);
    }
}
main()
    .catch(e => {
